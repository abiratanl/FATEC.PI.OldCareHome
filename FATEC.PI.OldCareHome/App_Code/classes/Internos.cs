...
public class Internos{
    ...
    public string Int_sexo { get => int_sexo; set => int_sexo = value; }
    public string Int_cpf { get => int_cpf; set => int_cpf = value; }
}